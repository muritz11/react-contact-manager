...
class AddContact extends React.Component{
  ...
  render(){
    return (
      <form onSubmit={this.handleSubmit} className='form-inline ml-5 p-3'>
        <input type='text' placeholder='Add new contact' onChange={this.handleInput} value={this.state.newPerson}  className="form-control col-8 mr-3" />
        <button type='submit' className="btn btn-info form-control col-1">Add</button>
      </form>
    );
  }
}
